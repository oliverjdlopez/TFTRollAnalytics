...
import ConditionalChart from "./ConditionalChart.tsx";
import RolldownSim from "../RolldownSim";
import {handleNameUpdate, handleOobTargetUpdate, handleSimulate, handleClear,
    handleAddTarget, handleOobNonTargetUpdate, handleProbTypeUpdate, handleNSimsUpdate} from "./conditionalHandlers.js";
import {allNames, bagSize, COSTS, nameToCost, poolSize} from "../utilsSet14";
    ...
    return (
        <div className="App">
          ...
          <div className={"inputDescription"}>
            ...
            <ConditionalChart cfg={cfg} results={results}/>
